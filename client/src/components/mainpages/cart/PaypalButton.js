    ...
    render() {
        const onSuccess = (payment) => {
            // Congratulation, it came here means everything's fine!
            		console.log("Plata cu succes", payment);
        ...
        const onCancel = (data) => {
            ...
            console.log('Plata a fost anulata', data);
        ...
        const client = {
            sandbox:    'ASYUeqahBa4AQRzpUgqOfbHssLDfMLtp1T9_PSDB0veOuTUmJ1mOuM1byhbVU8rcuOXRUR5Ua7V20LVJ',
